...
public class CreateQrcode_IDCard {
	...
	public static void main(String[] args) throws IOException {
        ...
        String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:http://p3.so.qhimgs1.com/bdr/_240_/t014691597995c945d3.jpg\n" +
                   "FN:姓名:潘新荣\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:18832886058\n"+
                   "TEL;WORK,VOICE:无\r\n"+
                   "URL;WORK:http://www.hevttc.edu.cn\n"+
                   "EMAIL;INTERNET,HOME:1586528401@qq.com\n"+
                   "END:VCARD";//二维码扫出来的内容
        //得到一个二维数组
        ...
        Image logo=ImageIO.read(new File("D:/头像/pxrid.jpg"));
        int logosize=50;
        int logox=(imagesize-logosize)/2;
        gs1.drawImage(logo,logox, logox, logosize, logosize, null);
        gs1.dispose();
    	bufferedimage.flush();
    	ImageIO.write(bufferedimage,"png",new File("D:/pxridcard.png"));
	}
}
